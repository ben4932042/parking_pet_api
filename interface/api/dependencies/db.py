...
def get_property_audit_repository(client: MongoDBClient = Depends(get_db_client)) -> PropertyAuditRepository:
    return PropertyAuditRepository(
        client=client, collection_name="property_audit_logs"
    )
