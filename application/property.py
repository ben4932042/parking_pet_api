...
from domain.entities.property import PropertyDetailEntity
...
class PropertyService:
    ...
    async def get_details(self, property_id: PyObjectId) -> PropertyDetailEntity:
        output = await self.repo.get_property_by_id(property_id)
        return PropertyDetailEntity(
            ...
            types=output.types.split(", "),
            rating=output.rating,
            tags=output.ai_analysis.suitable_for,
