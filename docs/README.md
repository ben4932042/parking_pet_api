...
This directory stores durable development guidance and feature-specific documentation.

This file is the canonical index for everything under `docs/`.
...
Use these documents when working on a specific product area.

#### Search

Must-read agent docs:
...
- Use `workflow-*.md` for execution-oriented, primarily agent-facing documents.
- Use `guide-*.md` for human-oriented explanatory documents and diagram-heavy walkthroughs.

For the detailed rationale and decision rules, read `docs/documentation/architecture.md`.
